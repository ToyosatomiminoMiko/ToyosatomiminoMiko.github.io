...
//
// 为什么要单独一步:src/metro_window/web/pkg/ 是 wasm-bindgen 的生成物(已 gitignore),
// 而 src/metro_window/web/src 里的 TS 是**静态 import** 它的.少了这层检查,
// 用户拿到的会是 Vite 或 tsc 的 "Failed to resolve import ..." --
// 说得没错,但没告诉他该跑什么.
import { existsSync } from 'node:fs';

const artifact = 'src/metro_window/web/pkg/metro_window.js';
